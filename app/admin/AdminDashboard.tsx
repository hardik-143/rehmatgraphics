            ...
            {activityStats && (
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-3 text-3xl font-semibold text-slate-900">{activityStats.totalActivities}</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="flex items-center justify-between">
                    <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Selected Range</p>
                  ...
                  <p className="mt-3 text-3xl font-semibold text-slate-900">
                    {typeof activityStats.rangeActivities === "number" ? activityStats.rangeActivities : activityStats.todayActivities}
                  </p>
                </div>
              </div>
            )}
