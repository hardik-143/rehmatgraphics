...
const AdminSidebar = ({
  ...
  return (
    <>
      ...
      />
      <aside className={`w-64 flex-col border-r border-slate-200 bg-white/90 px-6 py-8 shadow-sm lg:flex max-md:fixed max-md:inset-y-0 max-md:left-0 max-md:z-50 max-md:overflow-y-auto max-md:bg-white/95 max-md:backdrop-blur-lg  max-md:transition-transform max-md:duration-300 max-md:ease-in-out md:max-md:w-72 lg:max-md:w-64 ${isMobileOpen ? "max-md:translate-x-0" : "max-md:-translate-x-full"}`}>
        <div className="mb-10">
